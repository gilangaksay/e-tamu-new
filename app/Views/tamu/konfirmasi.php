...
<head>
    ...
    <style>
        body { font-family: 'Times New Roman', Times, serif; background: #fdfdff; height: 100vh; display: 
            flex; align-items: center; justify-content: center; }
        .success-card { max-width: 450px; width: 100%; }
        .antrian-number { font-size: 6rem; line-height: 1; margin-bottom: 1.5rem; background: var(--grad); 
...
<body>
    ...
    <div class="success-card text-center">
        <div class="modern-card p-5 bg-white">
            ...
            d-inline-flex align-items-center justify-content-center mb-4" style="width:80px; height:80px;">
            ...
            <div class="text-start mb-4 p-4 rounded-4 bg-light border border-white">
                <div class="mb-3">
                    <small class="text-muted d-block uppercase tracking-wider" style="font-size:0.6rem; 
                    font-weight:700;">Nama Lengkap</small>
                    <div class="fw-bold fs-5 text-dark"><?= esc($tamu['nama']) ?></div>
                </div>
                <div class="mb-3">
                    <small class="text-muted d-block uppercase tracking-wider" style="font-size:0.6rem; 
                    font-weight:700;">Keperluan Kunjungan</small>
                ...
                <div class="row g-2">
                    <div class="col-4">
                        ...
                        <div class="fw-bold text-dark small"><?= $tamu['jenis_kelamin'] == 'L' ? 
